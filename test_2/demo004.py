...
driver.find_element_by_name('user.loginPassword').send_keys('b123456')                 #输入密码
...
driver.find_element_by_name('nowPassword').send_keys('b123456')
driver.find_element_by_name('newPassword').send_keys('a123456')
driver.find_element_by_name('confirmPwd').send_keys('a123456')
time.sleep(2)
driver.find_element_by_css_selector('button.btn.btn-info.subbtn-info').click()
time.sleep(3)
...
driver.find_element_by_class_name('mian-nav-right-user').click()
time.sleep(5)
driver.find_element_by_xpath('//*[@id="mian-nav"]/div/div/div[2]/div[2]/div/ul/li[5]').click()
time.sleep(3)
